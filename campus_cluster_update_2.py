...
"""
    ...
    for openmp_option, cuda_arch_option in itertools.product(openmp_options, cuda_arch_options):
        ...
        for build_type in build_types_arr:
            ...
            mfem_cmake_cmd = f"cmake ../mfem -DCMAKE_INSTALL_PREFIX=../install -DCMAKE_BUILD_TYPE={build_type} -DMETIS_DIR={build_once_dir_path}/metis-5.1.0/build/Linux-x86_64/install -DHYPRE_DIR={build_dependent_dir_path}/hypre_dev/hypre/install -DMFEM_USE_MPI=YES"
            if cuda_enabled:
